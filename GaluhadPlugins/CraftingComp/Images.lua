...
_IMAGES =
	...
	["MAINICON"] = RESOURCEDIR .. "MainIcon.tga";-- desktop icon
	...
	["PROGRESSBARBACK"] = RESOURCEDIR .. "ProgressBar_Back.tga";
	["PROGRESSBARFILLRED"] = RESOURCEDIR .. "ProgressBar_Fill_Red.tga"; --148x13
	["PROGRESSBARFILLYELLOW"] = RESOURCEDIR .. "ProgressBar_Fill_Yellow.tga"; --148x13
